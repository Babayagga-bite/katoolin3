...
_(Last updated: 13/01/22)_

- __Removed Install all__
 The option -install all- for installing all the packages has been removed to avoid system failures for a mistake.
...
### Installation
```bash
git clone https://github.com/Babayagga-bite/katoolin3;
cd katoolin3;
chmod +x ./install.sh;
sudo ./install.sh;
```
